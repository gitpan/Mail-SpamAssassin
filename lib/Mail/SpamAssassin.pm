...
$SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2004-09-13 20:02:01 -0700 (Mon, 13 Sep 2004) $ updated by SVN'))[1];
...
if (defined $IS_DEVEL_BUILD && $IS_DEVEL_BUILD) {
  push(@EXTRA_VERSION, ( 'r' . qw{$LastChangedRevision: 46006 $ updated by SVN}[1] ));
}
