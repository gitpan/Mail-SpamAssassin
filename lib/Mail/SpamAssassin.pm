...
$VERSION = "3.001009";      # update after release (same format as perl $])
# $IS_DEVEL_BUILD = 1;        # change for release versions

@ISA = qw();

# SUB_VERSION is now just <yyyy>-<mm>-<dd>
$SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2007-02-13 14:18:39 -0800 (Tue, 13 Feb 2007) $ updated by SVN'))[1];
...
if (defined $IS_DEVEL_BUILD && $IS_DEVEL_BUILD) {
  push(@EXTRA_VERSION,
       ('r' . qw{$LastChangedRevision: 507262 $ updated by SVN}[1]));
}
